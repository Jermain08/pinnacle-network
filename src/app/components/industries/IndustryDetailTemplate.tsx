// components/industries/IndustryDetailTemplate.tsx
// Shared layout for every individual industry page.

import type { IndustryDetail } from "../../../lib/industries-data";
import CtaSection from "../../components/home/CtaSection";

export default function IndustryDetailTemplate({ industry }: { industry: IndustryDetail }) {
  return (
    <>
      <section className="border-b border-[var(--color-line)]">
        <div className="mx-auto max-w-4xl px-6 py-24 lg:px-10">
          ...
          <div className="mt-8 flex flex-col gap-4">
            {industry.intro.map((paragraph, i) => (
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 lg:px-10">
        ...
        {industry.note && (
          <p className="mt-10 rounded-xl border border-[var(--color-line)] bg-[var(--color-surface)] p-5 text-xs leading-relaxed text-[var(--color-mist-dim)]">
            {industry.note}
          </p>
        )}
      </section>
